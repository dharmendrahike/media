...
public class GPUImageView extends FrameLayout {
    ...
    public void setImage(final int textureId, final int imageWidth, final int imageHeight) {
        mGPUImage.setImageTexture(textureId, imageWidth, imageHeight);
    }
    ...
    public void saveToPictures(final String completeFilePath,
                               final OnPictureSavedListener listener) {
        new SaveTask(completeFilePath, listener).execute();
    }
    ...
    private class SaveTask extends AsyncTask<Void, Void, Void> {
        ...
        public SaveTask(final String filePath,
                        final OnPictureSavedListener listener) {
