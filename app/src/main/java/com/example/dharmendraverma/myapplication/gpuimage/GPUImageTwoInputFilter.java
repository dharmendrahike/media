...
public class GPUImageTwoInputFilter extends GPUImageFilter {
    ...
    private ByteBuffer mTexture2CoordinatesBufferVertFlipped;
    ...
    public GPUImageTwoInputFilter(String vertexShader, String fragmentShader) {
        ...
        mTexture2CoordinatesBuffer = setRotation(Rotation.NORMAL, false, false);
        mTexture2CoordinatesBufferVertFlipped = setRotation(Rotation.NORMAL, false, true);
    }
    ...
    protected void onDrawArraysPre() {
        ...
        if(!mFlipped) {
            ...
            mTexture2CoordinatesBufferVertFlipped.position(0);
            GLES20.glVertexAttribPointer(mFilterSecondTextureCoordinateAttribute, 2, GLES20.GL_FLOAT, false, 0, mTexture2CoordinatesBufferVertFlipped);

        }
    }

    public ByteBuffer setRotation(final Rotation rotation, final boolean flipHorizontal, final boolean flipVertical) {
