...
public class MoviePlayer implements FrameCallback {
    ...
    public MoviePlayer(int res, SurfaceTexture surfaceTexture,Context context)
            throws IOException {
        /*mSourceFile = sourceFile;*/
        ...
        mContext =context;
        Res =res;
        AssetFileDescriptor testFd = mContext.getResources().openRawResourceFd(Res);
        ...
        try {
            extractor = new MediaExtractor();
            extractor.setDataSource(testFd.getParcelFileDescriptor().getFileDescriptor(),
    ...
    public static class PlayTask implements Runnable {
        ...
        public PlayTask(MoviePlayer player) {
            mPlayer = player;
          /*  mFeedback = feedback;*/
