...
//        }
    ...
    public SurfaceTexture CreateVideoSurface(){
       return new SurfaceTexture(mGLTextureId);
    ...
    public void setImageTexture(final int glTextureID, final int imageWidth, final int imageHeight) {
    ...
    public void setmOutputHeight(int mOutputHeight) {
    ...
    protected void adjustImageScaling() {
        ...
        if (mScaleType == GPUImage.ScaleType.CENTER_CROP) {
            ...
            textureCords = new float[]{addDistance(textureCords[0], distHorizontal), addDistance(textureCords[1], distVertical), addDistance(textureCords[2], distHorizontal),
                    addDistance(textureCords[3], distVertical), addDistance(textureCords[4], distHorizontal), addDistance(textureCords[5], distVertical),
                    addDistance(textureCords[6], distHorizontal), addDistance(textureCords[7], distVertical),};
        } else {
            cube = new float[]{CUBE[0] / ratioHeight, CUBE[1] / ratioWidth, CUBE[2] / ratioHeight, CUBE[3] / ratioWidth, CUBE[4] / ratioHeight, CUBE[5] / ratioWidth,
